<div style="height:400px;position: absolute;right: -12%;" id="modalscheck"
    ...
    <div class="src-components-user-auth-___form-user__height___10l2k"
         data-reactid=".0.0.1">
        <noscript data-reactid=".0.0.1.0"></noscript>
        <html lang="pt-br" class="ComCupomBR-container">
        <head>
            <meta charset="utf-8">
            <meta http-equiv="X-UA-Compatible" content="IE=edge">
            <title>Login CupomBR</title>

            <link rel="stylesheet"
                  href="https://d2122awg1o49gd.cloudfront.net/css/login/min/iframe.css?cb=3747609978">

            <script id="facebook-jssdk"></script>
            <script
                src="https://d2122awg1o49gd.cloudfront.net/scripts/prototype.js?cb=3060005990"></script>
            <script
                src="https://d2122awg1o49gd.cloudfront.net/scripts/effects.js?cb=4152821831"></script>

            <script>
                var URL_JS = 'https://d2122awg1o49gd.cloudfront.net/scripts';
                var URL_FACEBOOK_LOGIN = 'https://secure.CupomBR.com/ajax/facebook';
                var FACEBOOK_APP_ID = '173460426152579';
                var FACEBOOK_URI = 'CupomBR.com';
            </script>
            <script
                src="https://d2122awg1o49gd.cloudfront.net/scripts/facebook.js?cb=2872961465"></script>
            ...
            <form
                ...
                <fieldset>
                    ...
                    <div class="forgot-pass">
                        <a href="http://www.CupomBR.com/lembrar-senha"
                           class="btn btn-link" target="_parent">
                            Esqueceu sua senha?
                        </a>
                    </div>
                </fieldset>
        ...
        <script
            src="https://d2122awg1o49gd.cloudfront.net/scripts/login/min/iframe.js?cb=1044208561"></script>


        <div id="fb-root" class=" fb_reset">
            <script src="https://connect.facebook.net/pt_BR/all.js" async=""></script>
            ...
            <div style="position: absolute; top: -10000px; height: 0px; width: 0px;">
                <div>
                    <iframe name="fb_xdm_frame_https" frameborder="0"
                            ...
                            tabindex="-1"
                            src="https://staticxx.facebook.com/connect/xd_arbiter/r/96nq-xsaNcg.js?version=42#channel=f1bfebd5c739f7c&amp;origin=https%3A%2F%2Fsecure.CupomBR.com"
